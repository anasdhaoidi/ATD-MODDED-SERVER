...
class BombFactory:
    ...
    def __init__(self) -> None:
        ...
        self.impact_bomb_mesh = bs.getmesh('bomb')
        self.land_mine_mesh = bs.getmesh('landMine')
        self.tnt_mesh = bs.getmesh('tnt')

        self.regular_tex = bs.gettexture('circleOutlineNoAlpha')
        self.ice_tex = bs.gettexture('powerupShield')
        self.sticky_tex = bs.gettexture('aliColorMask')
        self.impact_tex = bs.gettexture('powerupCurse')
        self.impact_lit_tex = bs.gettexture('black')
        self.land_mine_tex = bs.gettexture('ouyaUButton')
        self.land_mine_lit_tex = bs.gettexture('white')
        self.tnt_tex = bs.gettexture('levelIcon')
