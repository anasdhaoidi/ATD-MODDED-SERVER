...
def _set_ready(self, ready: bool) -> None:
    ...
    if profilename == '_edit' and ready:
        with babase.ContextRef.empty():
            ProfileBrowserWindow(in_main_menu=False)
    ...
    if not ready:
        self._sessionplayer.assigninput(
            ...
            babase.CallPartial(self.handlemessage, ChangeMessage('team', -1)))
        self._sessionplayer.assigninput(
            babase.InputType.RIGHT_PRESS,
            babase.CallPartial(self.handlemessage, ChangeMessage('team', 1)))
        self._sessionplayer.assigninput(
            babase.InputType.BOMB_PRESS,
            babase.CallPartial(self.handlemessage, ChangeMessage('character', 1)))
        self._sessionplayer.assigninput(
            babase.InputType.UP_PRESS,
            babase.CallPartial(self.handlemessage, ChangeMessage('profileindex', -1)))
        self._sessionplayer.assigninput(
        ...
        self._sessionplayer.assigninput(
            ...
            babase.CallPartial(self.handlemessage, ChangeMessage('ready', 1)))
        self._ready = False
        self._update_text()
        ...
        self._sessionplayer.assigninput(
            (babase.InputType.UP_PRESS),
            babase.CallPartial(self.handlemessage, ChangeMessage('characterchooser', -1)))
        self._sessionplayer.assigninput(
            (babase.InputType.DOWN_PRESS),
            babase.CallPartial(self.handlemessage, ChangeMessage('characterchooser', 1)))
        self._sessionplayer.assigninput(
            (babase.InputType.BOMB_PRESS),
            babase.CallPartial(self.handlemessage, ChangeMessage('ready', 0)))

        self._sessionplayer.assigninput(
            (babase.InputType.JUMP_PRESS, babase.InputType.PICK_UP_PRESS,
             babase.InputType.PUNCH_PRESS),
            babase.CallPartial(self.handlemessage, ChangeMessage('ready', 2)))
